...
public class FileStorageService2 {
     ...
     */
    public FileStorageService2 wrap(Object file) {
     ...
     * @return FileStorageService
     */
    public FileStorageService2 createFileHandler(Consumer<FileHandler> fileConfig) {
     ...
     * @return FileStorageService
     */
    public FileStorageService2 createImageHandler(Consumer<Thumbnails.Builder<? extends InputStream>> consumer) {
